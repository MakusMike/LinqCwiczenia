...
namespace LinqTutorials
{
    public static class LinqTasks
    {
        ...
        {
            IEnumerable<object> result = Depts.GroupBy(e => e.Dname)
                .Where(g => g.Count() > 1)
                .Select(g => new
                {
                    name = g.Key,
        ...
        public static IEnumerable<Dept> Task14()
        {
            ...
            IEnumerable<Dept> result = Depts
                .Where(d => empGroup.Contains(d.Deptno) || !Emps.ToList().Any(e => e.Deptno == d.Deptno))
                .OrderBy(d => d.Dname)
                .ToList();
        ...
        public static IEnumerable<Dept> Task15()
        {
            IEnumerable<Dept> result = Emps
                ...
                {
                    Deptno = 0, 
                    Dname = group.Key, //(Praca)
                    Loc = group.Count().ToString() //(LiczbaPracownikow)
                })
                .ToList();
